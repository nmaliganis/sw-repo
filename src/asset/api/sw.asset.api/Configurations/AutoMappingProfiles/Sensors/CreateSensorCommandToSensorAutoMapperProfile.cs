...
{
    internal class CreateSensorCommandToSensorAutoMapperProfile : Profile
    {
        public CreateSensorCommandToSensorAutoMapperProfile()
        {
            ConfigureMapping();
        }
        ...
        public void ConfigureMapping()
        {
            CreateMap<CreateSensorCommand, Sensor>()
                // .ForMember(dest => dest.AssetId, opt => opt.MapFrom(src => src.Parameters.AssetId))
                // .ForMember(dest => dest.DeviceId, opt => opt.MapFrom(src => src.Parameters.DeviceId))
                // .ForMember(dest => dest.SensorTypeId, opt => opt.MapFrom(src => src.Parameters.SensorTypeId))
        ...
        //internal class CreateJsonResolver : IValueResolver<CreateSensorCommand, Sensor, JsonDocument>
        //{
        //    public JsonDocument Resolve(CreateSensorCommand source, Sensor destination, JsonDocument member, ResolutionContext context)
        //    {
