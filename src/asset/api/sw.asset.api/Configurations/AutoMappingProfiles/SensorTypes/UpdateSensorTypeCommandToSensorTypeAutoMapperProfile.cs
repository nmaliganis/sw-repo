...
internal class UpdateSensorTypeCommandToSensorTypeAutoMapperProfile : Profile
{
  public UpdateSensorTypeCommandToSensorTypeAutoMapperProfile()
  {
    ConfigureMapping();
  }
  ...
  {
    CreateMap<UpdateSensorTypeCommand, SensorType>()
