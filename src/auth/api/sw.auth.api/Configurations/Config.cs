...
using sw.auth.api.Validators.Users;
...
using sw.auth.repository.NhUnitOfWork;
...
using sw.auth.services.V1.Members;
using sw.auth.services.V1.Roles;
...
namespace sw.auth.api.Configurations;
...
internal static class Config
{
    ...
    private static IServiceCollection ConfigureCompanyContracts(this IServiceCollection services)
    {
        ...
        services.AddScoped<IGetCompaniesByUserProcessor, GetCompaniesByUserProcessor>();
