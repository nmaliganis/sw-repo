...
{
    internal class PersonToPersonModificationUiAutoMapperProfile : Profile
    {
        public PersonToPersonModificationUiAutoMapperProfile()
        {
            ConfigureMapping();
        }
        ...
        {
            CreateMap<Person, PersonModificationUiModel>()
