...
function ReportsBinCollectionForm({ isLoading, setBinCollectionParams }) {
	...
	const onFormSubmit = useCallback(() => {
		if (validationEngine(formData)) {
			setBinCollectionParams(formData);
		}
	}, [validationEngine, formData, setBinCollectionParams]);
...
export default ReportsBinCollectionForm;
