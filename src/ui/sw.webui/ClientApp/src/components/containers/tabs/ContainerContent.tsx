...
// Settings for React-Plot 3D graph
const layout: any = {
	autosize: true,
	uirevision: true,
...
function ContainerContent() {
	...
	return <Plot style={{ width: "100%", height: "100%" }} data={data} useResizeHandler={true} config={config} layout={layout} />;
}
