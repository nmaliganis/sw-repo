...
namespace sw.landmark.web.api.Configurations.Installers
{
    internal static class SwaggerInstaller
    {
        public static IServiceCollection AddSwaggerInstaller(this IServiceCollection services)
        {
            services.AddSwaggerGen(c => {
                c.SwaggerDoc("v1", new OpenApiInfo() {
                    Title = "sw.landmark.api - HTTP API",
                    Version = "v1",
                    Description = "The Catalog Microservice HTTP API for sw.api service",
                });
        ...
        public static IApplicationBuilder UseSwaggerInstaller(this IApplicationBuilder app)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "sw.landmark.api - HTTP API");
            });
