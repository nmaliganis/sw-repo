...
{
    internal class GeocodedPositionToGeocodedPositionModificationUiAutoMapperProfile : Profile
    {
        public GeocodedPositionToGeocodedPositionModificationUiAutoMapperProfile()
        {
            ConfigureMapping();
        }
        ...
        {
            CreateMap<GeocodedPosition, GeocodedPositionModificationUiModel>()
