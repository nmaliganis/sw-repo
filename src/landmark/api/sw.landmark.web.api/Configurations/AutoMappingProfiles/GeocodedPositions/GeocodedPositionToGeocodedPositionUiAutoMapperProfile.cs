...
{
    internal class GeocodedPositionToGeocodedPositionUiAutoMapperProfile : Profile
    {
        public GeocodedPositionToGeocodedPositionUiAutoMapperProfile()
        {
            ConfigureMapping();
        }
        ...
        {
            CreateMap<GeocodedPosition, GeocodedPositionUiModel>()
