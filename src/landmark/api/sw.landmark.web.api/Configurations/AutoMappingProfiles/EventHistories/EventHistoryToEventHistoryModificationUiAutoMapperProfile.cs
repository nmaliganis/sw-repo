...
{
    internal class EventHistoryToEventHistoryModificationUiAutoMapperProfile : Profile
    {
        public EventHistoryToEventHistoryModificationUiAutoMapperProfile()
        {
            ConfigureMapping();
        }
        ...
        {
            CreateMap<EventHistory, EventHistoryModificationUiModel>()
