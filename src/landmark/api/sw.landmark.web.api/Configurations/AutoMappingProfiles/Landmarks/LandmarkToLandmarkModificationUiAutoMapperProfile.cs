...
{
    internal class LandmarkToLandmarkModificationUiAutoMapperProfile : Profile
    {
        public LandmarkToLandmarkModificationUiAutoMapperProfile()
        {
            ConfigureMapping();
        }
        ...
        {
            CreateMap<Landmark, LandmarkModificationUiModel>()
