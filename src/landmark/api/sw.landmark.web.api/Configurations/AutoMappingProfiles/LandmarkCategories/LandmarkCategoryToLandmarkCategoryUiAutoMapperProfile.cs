...
{
    internal class LandmarkCategoryToLandmarkCategoryUiAutoMapperProfile : Profile
    {
        public LandmarkCategoryToLandmarkCategoryUiAutoMapperProfile()
        {
            ConfigureMapping();
        }
        ...
        {
            CreateMap<LandmarkCategory, LandmarkCategoryUiModel>()
