...
{
    internal class EventPositionToEventPositionCreationUiModelAutoMapperProfile : Profile
    {
        public EventPositionToEventPositionCreationUiModelAutoMapperProfile()
        {
            ConfigureMapping();
        }
        ...
        {
            CreateMap<EventPosition, EventPositionCreationUiModel>()
