...
{
    internal class EventPositionToEventPositionModificationUiAutoMapperProfile : Profile
    {
        public EventPositionToEventPositionModificationUiAutoMapperProfile()
        {
            ConfigureMapping();
        }
        ...
        {
            CreateMap<EventPosition, EventPositionModificationUiModel>()
